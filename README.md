...
We have shown how to describe event sourced entities in the domain while keeping these definitions free of references to concrete implementations, and shown required infrastructure plumbing code which maps these definitions to Akka Persistence Typed.  

*Mention persistence (what's missing from the picture)*
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NDIyNzAxNTEsNjMyNTQyMDUsLTM5MD
